...
public class TwitterInstructionSource extends InstructionSource implements UserStreamListener {
    ...
    public void addInstruction(String instructionText) {
    	instruction = new Instruction(instructionText);
    	sendInstruction();
    }
...
//        System.out.println("onStatus @" + status.getUser().getScreenName() + " - " + status.getText());
        ...
        if(statusText.contains("@MaunHouse")) {
